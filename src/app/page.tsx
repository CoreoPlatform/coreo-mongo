export default function WelcomePage() {
    return (
        <div className="text-center">
          <h1 className="font-semibold text-3xl font-[family-name:var(--font-roboto)]">Welcome to Coreo-Mongo!</h1>
          <p className="text-lg mt-5 font-semibold font-[family-name:var(--font-roboto)]">
            Navigate your databases, inspect collections, and analyze documents in a structured and web-based interface.
          </p>
          ...
          <h2 className="mt-10 md:mt-15 font-semibold text-3xl font-[family-name:var(--font-roboto)]">What&apos;s new?</h2>
          <p className="mt-5 md:mt-7 font-semibold text-xl font-[family-name:var(--font-roboto)]">
            Checkout our <a href="" className="text-green-800">RELEASE</a> notes for more information about new versions. For the full history of changes see <a href="" className="text-green-800">CHANGELOG</a>.
          </p>
        </div>
    )
}
